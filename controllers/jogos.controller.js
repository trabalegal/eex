...
class jogosController {
    ...
    telaInicial = (requisicao, resposta) => { 
        ...
        resposta.sendFile('C:/Users/jptra/Downloads/tcchorrivel/gameranking/view/jogos/pagina-jogos.html')
    }

    telaFormulario = (requisicao, resposta) => { 
        resposta.set('Content-Type', 'text/html')
        resposta.sendFile('C:/Users/jptra/Downloads/tcchorrivel/gameranking/view/jogos/cadastro/cadastro-jogos.html')
    }
}
